...
public class TasacionService {
    ...
    public byte[] crearTasacion(TasacionDTO dto) throws Exception {
        ...
        t.setNombreSolicitante(dto.getNombreSolicitante());
        t.setDniSolicitante(dto.getDniSolicitante());
        ...
        t.setCuitProfesional(dto.getCuitProfesional());
        t.setTelefonoProfesional(dto.getTelefonoProfesional());
    ...
    private byte[] generarPdfDesdeEntidad(Tasacion t) throws Exception {
        ...
        builder.withHtmlContent(html, baseUri); // <-- Aquí pasamos la ruta base
        builder.toStream(os);
        builder.run();
